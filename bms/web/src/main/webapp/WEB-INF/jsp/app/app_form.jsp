    ...
    <spring-form:form id="data-form" commandName="appDTO" method="post" onsubmit="return false;">
        <c:if test="${appDTO.appId!=null}">
            <div class="form-group">
                <label class="form-control-static">应用ID</label>
                <div class="form-control-static">${appDTO.appId}</div>
            </div>
            <div class="form-group">
                <label class="form-control-static">应用密钥</label>
                <div class="form-control-static">${appDTO.appSecret}</div>
            </div>
        </c:if>
        <div class="form-group">
            <label class="form-control-static">资源列表</label>
        ...
        <div class="form-group">
            <label class="form-control-static">授权类型</label>
        ...
        <div class="form-group">
            <label class="form-control-static">权限</label>
        ...
        <div class="form-group">
            <label class="form-control-static">Token有效期</label>
        ...
        <div class="form-group">
            <label class="form-control-static">刷新Token有效期</label>
        ...
        <div class="form-group">
            <label class="form-control-static">回调地址</label>
        ...
        <div class="form-group">
            <label class="form-control-static">附加信息</label>
